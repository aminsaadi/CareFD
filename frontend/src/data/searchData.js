...
export const israeliRegions = [
  ...
  { 
    ...
    name: 'מרכז', 
    lat: 32.07, lng: 34.82,
    cities: ['תל אביב-יפו', 'פתח תקווה', 'ראשון לציון', 'חולון', 'בת ים', 'רמת גן', 'גבעתיים', 'בני ברק', 'לוד', 'רמלה', 'הרצליה', 'רעננה', 'כפר סבא', 'הוד השרון', 'רמת השרון', 'אור יהודה', 'קריית אונו', 'יהוד-מונוסון', 'גני תקווה']
  },
  { 
    id: 'jerusalem', 

            ...
            <Card key={p.id} className="overflow-hidden">
              <div className="p-4 flex items-center justify-between">
                <button onClick={() => setExpandedId(expandedId === p.id ? null : p.id)} className="flex items-center gap-3 flex-1 text-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-carefd-navy">{p.name}</h3>
              ...
              {expandedId === p.id && (
                <div className="border-t border-slate-100 bg-carefd-stone/30 p-4">
                  ...
                  <Button variant="ghost" size="sm" onClick={() => addSubProfession(p.id)} className="text-carefd-teal">

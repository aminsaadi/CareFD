  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof ApiError) {
        if (err.data?.detail === "email_not_verified") {
      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden bg-gradient-to-br from-carefd-navy via-[#1a3a4f] to-carefd-teal">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full px-12">
          ...
          <h1 className="text-4xl xl:text-5xl font-bold text-white text-center mb-4 font-heading leading-tight">
            מחברים בין מטופלים לספקי שירותי בריאות
          </h1>
        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <div className="mb-8">
              ...
              <p className="text-carefd-gray mt-2">התחברו לחשבון שלכם ב-{siteName}</p>
            </div>

            {/* Error Messages */}
            {error && (
              <div
                className="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-xl mb-6 text-center text-sm"
            ...
            {emailNotVerified && (
              <div
                className="bg-amber-50 border border-amber-200 px-4 py-4 rounded-xl mb-6 text-center"
                data-testid="email-not-verified-message"
              >
                <p className="text-amber-800 font-medium mb-2 text-sm">
                  כתובת הדואר שלך עדיין לא אומתה
                </p>
                <p className="text-amber-600 text-xs mb-3">
                  בדוק את תיבת הדואר שלך (גם בספאם) ולחץ על קישור האימות.
                </p>
                <button
                  type="button"
          ...
          <div className="text-center mt-6">
            <Link
              href="/"
              className="text-carefd-gray hover:text-carefd-teal transition flex items-center justify-center gap-2 text-sm"
            >
              <FaArrowLeft className="rtl:rotate-180" />
              חזרה לדף הבית
            </Link>

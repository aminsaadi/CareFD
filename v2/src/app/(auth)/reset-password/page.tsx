  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof ApiError) {
        toast.error(err.data?.detail || "שגיאה באיפוס הסיסמה");
      } else {
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          {!tokenValid ? (
            ...
            <div className="text-center py-6">
              ...
              <p className="text-carefd-gray mb-6">כעת תוכל להתחבר עם הסיסמה החדשה שלך.</p>
              <Link
                href="/login"
            ...
            // Reset password form
            <>
              <h2 className="text-2xl font-bold text-carefd-navy mb-2 text-center">
                הגדר סיסמה חדשה
              </h2>
              <p className="text-carefd-gray mb-6 text-center">בחר סיסמה חדשה לחשבון שלך</p>

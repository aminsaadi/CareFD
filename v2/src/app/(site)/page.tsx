      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-carefd-navy via-carefd-slate to-carefd-teal text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Right Content - Stats Cards - V1 style */}
            <div className="hidden lg:block space-y-4">
              {stats.map((stat, idx) => (
                <AnimatedSection key={stat.label}>
                  <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 border border-white/10 flex items-center gap-4 hover:bg-white/15 transition-all hover-lift">
                    <div className="w-14 h-14 bg-white/10 rounded-xl flex items-center justify-center">
                      <stat.icon className="w-7 h-7 text-carefd-teal-light" />
                    </div>
                    <div>

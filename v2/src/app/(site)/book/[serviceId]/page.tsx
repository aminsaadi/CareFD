    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-white to-carefd-teal-pale">
        ...
        <div className="text-center py-12">
          ...
          <Link href="/services" className="text-carefd-teal hover:underline mt-4 inline-block">חזור לשירותים</Link>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-2xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center border-2 border-green-500">
            ...
            <div className="flex gap-3">
              <Link href="/services" className="flex-1 bg-carefd-teal text-white py-3 rounded-xl font-semibold hover:bg-carefd-teal-medium transition">
                חזור לשירותים
              </Link>
              {isAuthenticated && (
                <Link href="/dashboard" className="flex-1 bg-white border-2 border-carefd-teal text-carefd-teal py-3 rounded-xl font-semibold hover:bg-carefd-teal-pale transition">
                  ההזמנות שלי
                </Link>
              )}
            </div>
            ...
            <FormSection icon={FaFileContract} title="תנאים ואישורים" testId="terms-section">
              <label className="flex items-start gap-3 p-3 bg-gray-50 rounded-xl mb-3 cursor-pointer hover:bg-carefd-teal-pale/20 transition">
                ...
                <span className="text-sm">
                  ...
                  <Link href="/terms" target="_blank" className="text-carefd-teal hover:underline">תנאי השימוש</Link>
              ...
              <label className="flex items-start gap-3 p-3 bg-gray-50 rounded-xl cursor-pointer hover:bg-carefd-teal-pale/20 transition">
                ...
                <div className="text-sm">
                  <span className="text-carefd-navy">אני מאשר/ת את </span>
                  <Link href="/terms#cancellation" target="_blank" className="text-carefd-teal hover:underline">מדיניות הביטולים</Link>
                  <span className="text-carefd-navy"> *</span>

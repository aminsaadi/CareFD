      ...
      <div className="container-main py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link href="/register?role=provider" className="text-carefd-light-gray hover:text-carefd-teal transition-colors">הרשמה כספק</Link></li>
        ...
        <div className="border-t border-carefd-slate/30 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-carefd-gray">&copy; {new Date().getFullYear()} CareFD. כל הזכויות שמורות.</p>
